...
{
    /// <summary>
    /// 文件说明: 眼底复查图像出血/渗出眼科信息实体映射
    /// 作    者: 袁恩龙
    /// 生成日期: 2017年08月17日
    /// 生成模板: CTSR.Template.Model.MVC_Model_01 版
    /// 修改说明：
    /// </summary>
    public class MEyeImageBleedingOculistMap : EntityTypeConfiguration<MEyeImageBleedingOculist>
    {
      public MEyeImageBleedingOculistMap()
      {
        //主键
        this.HasKey(t => t.EIBleedingOLID);
        ...
        //表与列的对应
        this.ToTable("MEyeImageBleedingOculist");
        this.Property(t => t.EIBleedingOLID).HasColumnName("EIBleedingOLID");
