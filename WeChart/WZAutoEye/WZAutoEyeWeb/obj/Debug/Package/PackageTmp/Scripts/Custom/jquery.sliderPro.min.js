...
!function (a, b) {
    ...
    d.prototype = {_init: function () {
        ...
        if (null !== g && this.$slider.addClass("ie ie" + parseInt(g[2], 10)), this.$slidesContainer = b('<div class="sp-slides-container"></div>').appendTo(this.$slider), this.$slidesMask = b('<div class="sp-mask"></div>').appendTo(this.$slidesContainer), this.$slides = this.$slider.find(".sp-slides").appendTo(this.$slidesMask), this.$slider.find(".sp-slide").appendTo(this.$slides), this.settings.shuffle === !0) {
            var h = this.$slides.find(".sp-slide"), i = [];
            h.each(function (a) {
    ...
    e.prototype = {_init: function () {
        ...
        return this.$slide.children().each(function (d, e) {
            var f = b(e), g = e.getBoundingClientRect(), h = f.position().top + (g.bottom - g.top), i = f.position().left + (g.right - g.left);
            h > c && (c = h), i > a && (a = i)
        }), {width: a, height: c}
    ...
    var f = {supportedAnimation: null, vendorPrefix: null, transitionEvent: null, getSupportedAnimation: function () {
    ...
    "use strict";
    var c = "Thumbnails." + b.SliderPro.namespace, d = {$thumbnails: null, $thumbnailsContainer: null, thumbnails: [], selectedThumbnailIndex: 0, thumbnailsSize: 0, thumbnailsContainerSize: 0, thumbnailsPosition: 0, thumbnailsOrientation: null, thumbnailsPositionProperty: null, isThumbnailScroller: !1, initThumbnails: function () {
        var a = this;
    ...
    "use strict";
    var c = "ConditionalImages." + b.SliderPro.namespace, d = {previousImageSize: null, currentImageSize: null, initConditionalImages: function () {
        ...
        if (this.currentImageSize = this.slideWidth <= this.settings.smallSize ? "small" : this.slideWidth <= this.settings.mediumSize ? "medium" : this.slideWidth <= this.settings.largeSize ? "large" : "default", this.previousImageSize !== this.currentImageSize) {
            ...
            b.each(this.slides, function (c, d) {
                ...
                e.find("img").each(function () {
                    var c = b(this), e = c.attr("data-" + a.currentImageSize);
    ...
    f.prototype = {_init: function () {
        this.$layer.attr("data-init", !0), this.$layer.hasClass("sp-static") ? this._setStyle() : this.$layer.css({visibility: "hidden", display: "none"})
    }, _setStyle: function () {
    ...
    "use strict";
    var c = "TouchSwipe." + b.SliderPro.namespace, d = {isTouchSupport: !1, touchStartPoint: {x: 0, y: 0}, touchEndPoint: {x: 0, y: 0}, touchDistance: {x: 0, y: 0}, touchStartPosition: 0, isTouchMoving: !1, touchSwipeEvents: {startEvent: "", moveEvent: "", endEvent: ""}, initTouchSwipe: function () {
